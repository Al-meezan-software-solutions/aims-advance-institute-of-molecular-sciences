        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-0 min-h-[calc(100vh-104px)]">
          ...
          <div id="highlights" className="flex flex-col justify-center py-20 lg:py-28 pl-8 lg:pl-20">
            ...
            <div className="grid grid-cols-2 gap-4" role="list" aria-label="Key statistics">
              ...
              >
                {/* Accent line */}
                <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-[#2BB7C4] rounded-l-xl" aria-hidden="true" />
                
                {/* Glow effect overlay */}
                <div 
                  className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_right,rgba(43,183,196,0.12),transparent_70%)] opacity-0 group-hover:opacity-100 transition-opacity duration-500" 
                  aria-hidden="true" 
                />
                ...
                <div className="p-6 flex items-center justify-between relative z-10">
                  <div className="flex-1 pr-4">
                    <div className="flex items-baseline gap-2 mb-1">
                      <span className="text-[2.2rem] font-bold text-[#2BB7C4] leading-none tracking-tight group-hover:text-white transition-colors duration-200">5</span>
                      <span className="text-[10px] font-bold text-[#2BB7C4]/70 uppercase tracking-widest">Accredited Standards</span>
                    </div>
                    
                    <h3 className="font-bold text-white text-sm lg:text-base group-hover:text-[#2BB7C4] transition-colors duration-200" style={{ fontFamily: 'var(--font-display)' }}>
                      Registrations &amp; Certifications
                    </h3>
                    <p className="text-white/60 text-xs mt-1 leading-relaxed max-w-sm" style={{ fontFamily: 'var(--font-body)' }}>
                      ISO/IEC 17025, DRAP, EPA, and BSL-2 quality certifications. Click to explore laboratory compliance records.
                    </p>
                  </div>
                  
                  {/* Icon badge */}
                  <div className="w-11 h-11 rounded-full bg-[#2BB7C4]/15 border border-[#2BB7C4]/25 flex items-center justify-center text-[#2BB7C4] shrink-0 group-hover:bg-[#2BB7C4] group-hover:text-white group-hover:border-transparent transition-all duration-300">
              ...
              return (
                <ScrollReveal key={svc.domain} delay={i * 60}>
                  <Link
                    ...
                    aria-label={`${svc.domain} — view details`}
                  >
                      ...
                      <ul className="space-y-1.5 mb-4">
                        {svc.bullets.slice(0, 3).map(b => (
                          <li key={b} className="flex gap-2 items-start">
                            <span className="mt-1.5 w-1.5 h-1.5 rounded-full shrink-0" style={{ background: accent.color }} aria-hidden="true" />
